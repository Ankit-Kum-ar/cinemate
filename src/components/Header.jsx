      ...
      <nav className="bg-white border-gray-300 border-b-2 dark:bg-gray-900 p-1 dark:border-b-2 dark:border-gray-800">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div id='mobile-nav' className="flex md:order-2">
            <button type="button" data-collapse-toggle="navbar-search" onClick={() => setHidden(!hidden)} aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1">
            ...
            {/* Creating a darkMode button that toggle the theme of page */}
          ...
          <div id='nav-links' className={` ${hidden ? "hidden" : ""} items-center justify-between w-full md:flex md:w-auto md:order-1`}>
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <NavLink to="/" className={({isActive}) => isActive ? activeClass : inActivClass} end>Home</NavLink> {/* This is way to active a className and inActive it when clicked on component*/}
              </li>
              <li>
